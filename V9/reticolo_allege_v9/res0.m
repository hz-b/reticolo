...
%  parm.res1.change_index:   anisotropie diagonale 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%  parm.res3.pertes_poynting   calcul des pertes avec Poynting  
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

if nargin<1;dim=2;end;
if dim==2;% 2 D
sym=struct('x',[],'y',[],'pol',0);
parm1=struct('angles',1,'trace',0,'xlimite',[],'ylimite',[],'nx',100,'ny',100,'calcul',1,'champ',0,'ftemp',1,'fperm',[],'sog',1,'li',1,'change_index',[]);
else;% 1 D
sym=struct('x',[]);
parm1=struct('trace',0,'xlimite',[],'nx',1000,'calcul',1,'champ',1,'ftemp',0,'fperm',[],'sog',1,'change_index',[]);

end;
parm2=struct('cals',1,'cale',1,'calef',1,'tolh',1.e-6,'tolb',1.e-6,'retss',3,'retgg',0,'result',1);
parm3=struct('npts',10,'cale',[1:6],'calo',i,'sens',1,'caltab',0,'gauss',0,'gauss_x',10,'gauss_y',nan,'trace',0,'champs',[1:6,0],'apod_champ',0,'pertes_poynting',0);
parm=struct('dim',dim,'sym',sym,'not_io',0,'res1',parm1,'res2',parm2,'res3',parm3);
